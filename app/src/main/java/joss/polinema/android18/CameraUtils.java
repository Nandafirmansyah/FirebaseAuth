...
public class CameraUtils {
    ...
    //cek perizinan camera dan audio
     ...
     */
    //memnbaggilan tampilan perizinan saat menekan kamera atau video
    ...
    public static File getOutputMediaFile(int type) {
        ...
        // External sdcard lokasi
        File mediaStorageDir = new File(
                Environment
                        .getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES),
                CameraActivity.GALLERY_DIRECTORY_NAME);

        // membuat untuk penyimpanan external di galeri
        ...
        // persiapan untuk type dari penyimpanan menggunakan gambar dan video
